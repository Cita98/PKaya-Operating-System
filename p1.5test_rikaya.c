...
/* This function returns the terminal transmitter status value given its 
address */
...
/* This function prints a string on specified terminal and returns TRUE 
if 
 ...
 *	causes the string to be written out to terminal0.  After this is 
done
